...
public class WaveView extends RenderView {
    ...
    protected void onRender(Canvas canvas, long millisPassed) {
        ...
        for (int i = 2; i < crestAndCrossCount; i += 2) {
            ...
            paint.setShader(new LinearGradient(0, centerHeight + crestY, 0, centerHeight - crestY,Color.argb(255,0x19,0x33,0x4d), Color.argb(60,0x19,0x33,0x4d), Shader.TileMode.CLAMP));
        ...
        paint.setColor(Color.argb(255,0x00,0xF5,0xFF));
        canvas.drawPath(firstPath, paint);

        //绘制下弦线
        paint.setColor(Color.argb(122,139,123,139));
        canvas.drawPath(secondPath, paint);
